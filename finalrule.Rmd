...
### too few observations to do analyses w1b2 and w1b3 (n=10/9 who had GC involved in policy)
...
stargazer(b1a1, b1a2, b1a3,
          ...
          single.row = TRUE,
          no.space = TRUE,
          title = "Effects of departmental, institutional, and portal policies on perceived benefits")
...
stargazer(h1a1, h1a2, h1a3,
          ...
          single.row = TRUE,
          no.space = TRUE,
          title = "Effects of departmental, institutional, and portal policies on perceived harms")
...
stargazer(w1a1, w1a2, w1a3,
          ...
          single.row = TRUE,
          no.space = TRUE,
          title = "Effects of departmental, institutional, and portal policies on perceived workflow impact")
...
stargazer(b1b1, h1b1,
          type = "html",
          out = "harms_benefits_1b.doc", #output will be as a separate word document
          single.row = TRUE,
          no.space = TRUE,
          title = "Effects of departmental, institutional, and portal policies on perceived benefits")
...
stargazer(w1b1,
          ...
          single.row = TRUE,
          no.space = TRUE,
          title = "Effects of departmental, policies on perceived workflow impact")
