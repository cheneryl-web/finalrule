...
data$policies_institutional_1a <- ifelse(data$institutional.level.policies.for.results.notes.release. %in% 
                                           c("This DOES NOT exist", "I am not sure"), 0, ifelse(is.na(data$variable), NA, 1))

data$policies_dept_1a <- ifelse(data$department..division..or.workgroup.level.policies.for.results.notes.release. %in% 
                                  c("This DOES NOT exist", "I am not sure"), 0, ifelse(is.na(data$variable), NA, 1))
