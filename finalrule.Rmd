...
#subset the variables that you are considering using in the model ***change these if needed
tmp<- subset(data, select = c("benefits", "policies_institutional_1a", "ordering_provider", "position", "workplacesetting", "demo_years"))
...
```{r}
#*** WRITE CODE HERE - use the previous code as a template using "policies_portal_1a" as the main predictor, "benefits" as the outcome, and the same covariates. Change the formula if different covariates are selected via stepwise selection

#subset the variables that you are considering using in the model ***change these if needed
tmp<- subset(data, select = c("benefits", "policies_portal_1a", "ordering_provider", "position", "workplacesetting", "demo_years"))
...
#subset the variables that you are considering using in the model ***change these if needed
tmp<- subset(data, select = c("harms", "policies_dept_1a", "ordering_provider", "position", "workplacesetting", "demo_years"))
...
#subset the variables that you are considering using in the model ***change these if needed
tmp<- subset(data, select = c("harms", "policies_institutional_1a", "ordering_provider", "position", "workplacesetting", "demo_years"))
...
#subset the variables that you are considering using in the model ***change these if needed
tmp<- subset(data, select = c("harms", "policies_portal_1a", "ordering_provider", "position", "workplacesetting", "demo_years"))
...
stargazer(h1a1, h1a2, h1a3,    #***add more models here - e.g., b1a2, b1a3
          type = "html",
