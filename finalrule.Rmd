...
desc<-data%>%
  select(position, demo_years, workplacesetting, ordering_provider, demo_list, demo_raceethnicity___1:demo_raceethnicity___8, demo_gender___1:demo_gender___7, demo_age) # ***add more demographic variables if needed
