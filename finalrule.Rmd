...
```{r}
#subset the variables that you are considering using in the model ***change these if needed
tmp<- subset(data, select = c("work", "policies_dept_1a", "ordering_provider", "position", "workplacesetting", "demo_years"))
...
```{r}
#subset the variables that you are considering using in the model ***change these if needed
tmp<- subset(data, select = c("work", "policies_institutional_1a", "ordering_provider", "position", "workplacesetting", "demo_years"))
...
```{r}
#subset the variables that you are considering using in the model ***change these if needed
tmp<- subset(data_d, select = c("work", "policies_portal_1a", "ordering_provider", "position", "workplacesetting", "demo_years"))
